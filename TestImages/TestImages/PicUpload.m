                     ...
                     picFileName: (NSMutableArray *)picFileName
{
    ...
    for (int i = 0; i < picFilePath.count; i ++) {
      ...
      //  data = UIImageJPEGRepresentation(image, 0.1);
       // 判断图片是不是png格式的文件
        ...
        [fileTitle appendFormat:@"Content-Type:application/octet-stream\r\n\r\n"];
      //  [fileTitle appendString:[NSString stringWithFormat:@"Content-Type:application/octet-stream%@",end]];
       ...
       // [myRequestData1 appendData:[datastr dataUsingEncoding:NSUTF8StringEncoding]];
    ...
    NSString *content=[[NSString alloc]initWithFormat:@"multipart/form-data;charset=utf-8; boundary=%@",boundary];
    //设置HTTPHeader
